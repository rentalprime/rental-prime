...
const supabaseAnonKey =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlxY3RhcnVtbnhzeHlxa3p4Zmt6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDY5NDc4MTAsImV4cCI6MjA2MjUyMzgxMH0.QvlZGTAHi1T3DThSbgkWIHvj_w7l6wqW25xIPdXZ8xc";
  ...
  try {
    ...
    if (userError) {
      ...
      if (userError.code === "42P01") {
        console.log(
          "Users table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
      ...
      console.log(
        "Successfully created users table and inserted admin user:",
        userData
      );
    }
    ...
    if (categoryError) {
      ...
      if (categoryError.code === "42P01") {
        console.log(
          "Categories table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
          "Please execute the following SQL in your Supabase dashboard:"
        );
      ...
      console.log(
        "Successfully created categories table and inserted sample category:",
        categoryData
      );
    }
    ...
    if (listingError) {
      ...
      if (listingError.code === "42P01") {
        console.log(
          "Listings table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
          "Please execute the following SQL in your Supabase dashboard:"
        );
      ...
      console.log(
        "Successfully created listings table and inserted sample listing:",
        listingData
      );
    }
    ...
    if (paymentError) {
      ...
      if (paymentError.code === "42P01") {
        console.log(
          "Payments table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
          "Please execute the following SQL in your Supabase dashboard:"
        );
      ...
      console.log(
        "Successfully created payments table and inserted sample payment:",
        paymentData
      );
    }
    ...
    if (planError) {
      ...
      if (planError.code === "42P01") {
        console.log(
          "Plans table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
          "Please execute the following SQL in your Supabase dashboard:"
        );
        console.log(`
          CREATE TABLE public.plans (
            ...
            created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
            updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
            CONSTRAINT interval_check CHECK (interval IN ('monthly', 'quarterly', 'half-yearly', 'yearly'))
          );
        `);
      }
    } else {
      console.log(
        "Successfully created plans table and inserted sample plan:",
        planData
      );
    }
    ...
    if (settingError) {
      ...
      if (settingError.code === "42P01") {
        console.log(
          "Settings table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
          "Please execute the following SQL in your Supabase dashboard:"
        );
      ...
      console.log(
        "Successfully created settings table and inserted sample setting:",
        settingData
      );
    }
    ...
    if (notificationError) {
      ...
      if (notificationError.code === "42P01") {
        console.log(
          "Notifications table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
          "Please execute the following SQL in your Supabase dashboard:"
        );
      ...
      console.log(
        "Successfully created notifications table and inserted sample notification:",
        notificationData
      );
    }
    ...
    if (supportError) {
      ...
      if (supportError.code === "42P01") {
        console.log(
          "Support table does not exist, creating it through SQL in Supabase dashboard..."
        );
        console.log(
          "Please execute the following SQL in your Supabase dashboard:"
        );
      ...
      console.log(
        "Successfully created support table and inserted sample support ticket:",
        supportData
      );
    }
